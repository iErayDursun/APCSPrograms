...
public class ProcessTransactions
{
    public static void main(String[] args){
        ...
        while(addDay==true){
            ...
            //prints day
            System.out.println("Results for day "+day+":\n");
            ...
            System.out.println("Amount of deposits: "+Account.getAmtDeposits());
            //Print total amount of withdrawals
            System.out.println("Amount of withdrawals: "+Account.getAmtWithdrawals());

            //resets values
            Account.resetDay();
            day++;

            System.out.println("Would you like to continute to day 2? (y/n)");
            input = scan.next();
